...
# ------- Rankings view (simple) -------
def rankings(request):
    """Show players ranked by chips (descending)."""
    # Use the Player model to build a simple leaderboard
    players = Player.objects.select_related('user').order_by('-chips')
    context = {'players': players}
    return render(request, 'poker/rankings.html', context)
